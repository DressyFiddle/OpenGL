...
If the setup of your compiler was successful, you should be able to compile all test cases without any issue.
Same can be used along with online docs to expand and add features.
